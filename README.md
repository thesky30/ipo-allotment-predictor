...
| lgbm_t1（研究对照） | T-1 | 624 | 0.115 | 0.903 | 0.953 |
| lgbm_t1plus | T+1 | 624 | 0.108 | 0.918 | 0.970 |

- 正式模型（T-6）OOS Spearman 为 0.512；询价结果释放后，T-1 研究对照模型逐年 OOS Spearman：2022=0.984 / 2023=0.894 / 2024=0.941 / 2025=0.975 / 2026=0.985。
