...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 主板 | 112 | 105 | 0 | 2023-04-10 | 2026-05-18 | 8,622.80 | 8,376.71 | 9.06 | 0.01 |  |  | 9.17 | 7 |
...
| --- | --- | --- | --- |
| inquiry_oversubscription_ratio | 1,130 | 0.8695 | 0.7830 |
| a_investor_allotted_accounts | 1,218 | 0.7617 | 0.7527 |
| inquiry_allotment_accounts | 1,130 | 0.6640 | 0.7749 |
...
| inquiry_subscription_total_10k | 1,130 | 0.4082 | 0.1591 |
| inquiry_investors_count | 1,130 | 0.3857 | -0.0934 |
| recent_ipo_first_day_return_ma20 | 1,115 | 0.3758 | 0.3102 |
...
| excluded_subscription_share_pct | 1,235 | -0.4869 | -0.3393 |
| clawback_ratio_pct | 1,235 | 0.4720 | 0.4242 |

## 6. 主要结论

- 板块差异很强：主板 网下超额认购倍数中位数最高 (8,622.80 倍)，北交所 最低 (21.37 倍)。
- 预测前可用字段中，`inquiry_oversubscription_ratio` 与标签的 Spearman 相关绝对值最高，为 0.870，方向为正相关。
...
| quote_price_weighted_avg | 523 | 0.3183 |
| quote_price_median | 523 | 0.3183 |
| quote_price_vs_offer | 523 | 0.3183 |
| inquiry_deadline_date | 513 | 0.3122 |
| subscription_deadline_date | 513 | 0.3122 |
...
| inquiry_subscription_total_10k | 22,838.5308 | 64,247,355.7000 | 12 | 12 | 永顺生物 | 1,452.8800 | 和辉光电-U | 227,025,750.0000 |
| inquiry_investors_count | 207.4500 | 766.6300 | 12 | 12 | 一诺威 | 58.0000 | 贝特瑞 | 1,175.0000 |
